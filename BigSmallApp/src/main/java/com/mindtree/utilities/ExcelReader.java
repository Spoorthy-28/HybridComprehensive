...
public class ExcelReader {
	...
	public ArrayList<String> getExcelData() throws IOException{
		FileInputStream fs = new FileInputStream("C:\\Users\\Spoorthy\\eclipse-workspace\\BigSmallApp\\testdata\\excel2.xlsx");
		...
		while(ri.hasNext()) {
			Row row = ri.next();
			if(row.getCell(columnidx).getStringCellValue().equalsIgnoreCase("login")) {
